...
class navSensors():
    ...
    def get_params(self):
        ...
        self.ZBA_autoback = rospy.get_param("~ZBA_autoback", 6) # 10
    ...
    def callback_msg_scan(self, msg):
        ...
        self.scan['front']= ranges[:145] 
        self.scan['back']= ranges[-755:-565]
        self.scan['hud_F']= ranges[-20:] + ranges[:165]
        self.scan['hud_B']= ranges[-775:-545]
