// Generated by gencpp from file v_msgs/Marker.msg
// DO NOT EDIT!


#ifndef V_MSGS_MESSAGE_MARKER_H
#define V_MSGS_MESSAGE_MARKER_H
...
struct Marker_
{
  ...
  typedef boost::shared_ptr< ::v_msgs::Marker_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::v_msgs::Marker_<ContainerAllocator> const> ConstPtr;

}; // struct Marker_

typedef ::v_msgs::Marker_<std::allocator<void> > Marker;

typedef boost::shared_ptr< ::v_msgs::Marker > MarkerPtr;
typedef boost::shared_ptr< ::v_msgs::Marker const> MarkerConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::v_msgs::Marker_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::v_msgs::Marker_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg'], 'v_msgs': ['/home/eaibot/dashgo_ws/src/v_msgs/msg']}
...
template <class ContainerAllocator>
struct IsFixedSize< ::v_msgs::Marker_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::v_msgs::Marker_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::v_msgs::Marker_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::v_msgs::Marker_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::v_msgs::Marker_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::v_msgs::Marker_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::v_msgs::Marker_<ContainerAllocator> >
{
  ...
  static const char* value(const ::v_msgs::Marker_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4048c9de2a16f4aeULL;
  static const uint64_t static_value2 = 0x8e0538085ebf1b97ULL;
};

template<class ContainerAllocator>
struct DataType< ::v_msgs::Marker_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::v_msgs::Marker_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::v_msgs::Marker_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::v_msgs::Marker_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::v_msgs::Marker_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
