...
def callback_emergencybt(data):
	global EMbt_status
	status = data.data
	if status!=EMbt_status:
		EMcmd = "_EMstop_" if status!=0 else "_EMnone_"
		GATE_write(EMcmd);
...
if __name__ == '__main__':
    try:
        ...
        rospy.Subscriber("emergencybt_status", Int32, callback_emergencybt)
