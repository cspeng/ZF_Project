...
#define T_const2 0  // PID overshoot was 10*C on setPoint
...
void data_Convert_char()
{
   ...
   paraDataPak.chSetpoint = String(setPoint,0);
...
void probe_access() 
{
  if ((millis() - lastTempUpdate) > trackRate) {
    ...
    regBank.set(40007, varTime_set1);
    regBank.set(40008, varTime_set2);
    regBank.set(40009, varCount_set1);
    regBank.set(40010, varCount_set2);
    regBank.set(40011, apName[8]*256 + apName[9]);
    regBank.set(40012, apName[10]*256 + apName[11]);
    regBank.set(40013, apName[12]*256 + apName[13]);
    regBank.set(40014, apName[14]*256 + apName[15]);
    regBank.set(40015, apName[16]*256 + apName[17]);
    regBank.set(40016, apName[18]*256 + apName[19]);
    delay(2);
 ...
 */
  ...
  setPoint = (float)regBank.get(40017);
  probe_access();
